...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-primary">
        <a class="navbar-brand" href="index.html"><p style="font-size:30px;"><b>Laundry OnLine</b></p></a>
    ...
    <div class="jumbotron jumbotron-fluid bg-white">
        <div class="container">
            ...
            <p>Melalui website Laundry Online, Kamu dapat membuat order dengan memilih lokasi Kamu untuk penjemputan dan pengembalian. Setelah itu, kamu pilih layanan yang kamu inginkan, buat order, dan menyelesaikan transaksi pembayaran. kemudian laundry akan di antarkan di alamatmu</p>
            <br>
